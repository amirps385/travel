          ...
          <div class="lg:w-3/5 p-8 md:p-10 lg:p-12">
            <div class="h-full flex flex-col justify-center">
              ...
              <div class="inline-flex items-center mb-6">
                ...
                <span class="mx-4 text-amber-300 font-semibold tracking-wider text-sm uppercase">Free Consultation</span>
                <div class="w-12 h-1 bg-linear-to-r from-transparent via-amber-500 to-transparent rounded-full"></div>
              </div>
              ...
              <p class="text-gray-300 text-lg md:text-xl mb-8 leading-relaxed">
                Book a free 30-minute call to get personalized advice about safaris, Kilimanjaro routes, and the best times to visit Tanzania.
              </p>
          ...
          <div class="lg:w-2/5 bg-white/5 backdrop-blur-sm p-8 md:p-10 lg:p-12 flex flex-col items-center justify-center border-t lg:border-t-0 lg:border-l border-white/20">
            <div class="text-center">
              ...
              <div class="relative mb-6">
                <div class="w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden mx-auto border-4 border-white/30 shadow-2xl relative group">
                  <div class="absolute inset-0 bg-linear-to-br from-amber-500/20 to-emerald-500/20 opacity-50 group-hover:opacity-30 transition-opacity"></div>
                  <img 
                    :src="expertImage" 
                ...
                <!-- Verified badge with safari styling -->
                <div class="absolute bottom-4 right-1/4 transform translate-x-1/2">
                  <div class="w-10 h-10 rounded-full bg-linear-to-r from-emerald-500 to-emerald-600 flex items-center justify-center shadow-lg border-2 border-white/30">
              ...
              <div class="mt-4 flex flex-wrap justify-center gap-2">
                <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs bg-emerald-500/10 text-emerald-300 border border-emerald-500/20">
                  <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path>
                  </svg>
                  Kilimanjaro
                </span>
                <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs bg-amber-500/10 text-amber-300 border border-amber-500/20">
                  <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064"></path>
                  </svg>
                  Safari
                </span>
                <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs bg-blue-500/10 text-blue-300 border border-blue-500/20">
                  <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
