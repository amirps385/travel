              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    type="datetime-local"
                    @blur="validateDate('preferredTime')"
                    class="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500 transition"
                    :class="{ 'border-red-400': dateErrors.preferredTime, 'border-green-400': dateValidations.preferredTime }"
                  />
                  <p v-if="dateErrors.preferredTime" class="mt-2 text-sm text-red-400">{{ dateErrors.preferredTime }}</p>
                </div>
