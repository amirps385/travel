  ...
  <td class="py-2 pr-4 text-right">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        <div v-else-if="activeSection === 'activities'">
          ...
          >
            ...
            <p class="text-sm text-slate-500 mb-4">
              Manage available activities like safaris, beach days, treks and more.
            </p>
            <ul class="space-y-2 text-sm">
              <li
                v-for="act in activitiesAdmin"
                :key="act.id"
                class="flex justify-between items-center rounded-xl border px-4 py-2 hover:bg-slate-50"
              >
                <div>
                ...
                <span class="text-xs text-slate-500">{{ act.code }}</span>
              </li>
            </ul>
          </div>
        </div>
    ...
    <transition name="fade">
      <div
        ...
        class="fixed inset-x-0 top-20 bottom-0 z-50 flex"
      >
        <!-- overlay -->
...
// ---- Itineraries / Hotels / Activities demo data ----
const itineraries = [
...
const activitiesAdmin = [
  { id: 1, name: 'Game drive (full day)', type: 'Safari', duration: '1 day', code: 'ACT-SAF-01' },
  { id: 2, name: 'Stone Town walking tour', type: 'City tour', duration: 'Half day', code: 'ACT-CTY-02' },
  { id: 3, name: 'Kilimanjaro day hike', type: 'Trek', duration: '1 day', code: 'ACT-TRK-03' }
]
</script>
